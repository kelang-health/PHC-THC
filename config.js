...
if (typeof window !== 'undefined') {
  import('./community-gis-v1822.mjs?v=1.8.63&p=2035')
    .then(async ({ initCommunityGIS1822 }) => {
      ...
      const { initMyHousesMobile } = await import('./my-houses-mobile-v1820.mjs?v=2.0.60&p=2060');
      ...
      const { initPHCFiveFeatures190 } = await import('./phc-five-features-v190.mjs?v=2.0.60&p=2060');
