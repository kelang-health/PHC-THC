...
if (typeof window !== 'undefined') {
  import('./community-gis-v1822.mjs?v=1.8.22')
    .then(async ({ initCommunityGIS1822 }) => {
      ...
      const { initVolunteerProfileRegistry1825 } = await import('./volunteer-profile-registry-v1825.mjs?v=1.8.33');
      await initVolunteerProfileRegistry1825(SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY);
      const { initVolunteerPhotoSource1826 } = await import('./volunteer-photo-source-v1826.mjs?v=1.8.33');
      ...
      const { initSystemAboutNote1829 } = await import('./system-about-note-v1829.mjs?v=1.8.33');
      initSystemAboutNote1829();
      const { initCommunityHouseholdQuality1831 } = await import('./community-household-quality-v1831.mjs?v=1.8.33');
