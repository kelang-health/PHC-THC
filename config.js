...
if (typeof window !== 'undefined') {
  import('./community-gis-v1822.mjs?v=1.8.55')
    .then(async ({ initCommunityGIS1822 }) => {
      ...
      const { initMyHousesMobile } = await import('./my-houses-mobile-v1820.mjs?v=1.8.55');
      await initMyHousesMobile(SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY);
      const { initMobileSpatialCards } = await import('./mobile-community-volunteer-cards-v1821.mjs?v=1.8.55');
      await initMobileSpatialCards(SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY);
      const { initCommunityWorkflow1822 } = await import('./community-workflow-v1822.mjs?v=1.8.55');
      ...
      const { initSystemAboutNote1829 } = await import('./system-about-note-v1829.mjs?v=1.8.55');
      initSystemAboutNote1829();
      const { initCommunityHouseholdQuality1831 } = await import('./community-household-quality-v1831.mjs?v=1.8.55');
