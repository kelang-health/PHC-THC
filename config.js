...
if (typeof window !== 'undefined') {
  import('./community-gis-v1822.mjs?v=1.8.63&p=2035')
    .then(async ({ initCommunityGIS1822 }) => {
      ...
      const { initCommunityWorkflow1822 } = await import('./community-workflow-v1822.mjs?v=1.8.63&p=2040');
      ...
      const { initVolunteerProfileRegistry1825 } = await import('./volunteer-profile-registry-v1825.mjs?v=1.8.36&p=2042');
      ...
      const { initCommunityHouseholdQuality1831 } = await import('./community-household-quality-v1831.mjs?v=1.8.63&p=2040');
