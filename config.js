...
if (typeof window !== 'undefined') {
  import('./community-gis-v1822.mjs?v=1.8.63')
    .then(async ({ initCommunityGIS1822 }) => {
      ...
      const { initPHCFiveFeatures190 } = await import('./phc-five-features-v190.mjs?v=2.0.7');
      await initPHCFiveFeatures190(SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY);
      const { initFieldWorkReportingV200 } = await import('./field-work-reporting-v200.mjs?v=2.0.7');
