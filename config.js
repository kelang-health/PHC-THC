...
if (typeof window !== 'undefined') {
  import('./community-gis-v1822.mjs?v=1.8.42')
    .then(async ({ initCommunityGIS1822 }) => {
      ...
      const { initSystemAboutNote1829 } = await import('./system-about-note-v1829.mjs?v=1.8.42');
      initSystemAboutNote1829();
      const { initCommunityHouseholdQuality1831 } = await import('./community-household-quality-v1831.mjs?v=1.8.42');
