...
if (typeof window !== 'undefined') {
  import('./community-gis-v1822.mjs?v=1.8.63&p=2035')
    .then(async ({ initCommunityGIS1822 }) => {
      ...
      const { initVolunteerProfileRegistry1825 } = await import('./volunteer-profile-registry-v1825.mjs?v=2.0.57&p=2057');
      ...
      const { initPHCFiveFeatures190 } = await import('./phc-five-features-v190.mjs?v=2.0.57&p=2057');
